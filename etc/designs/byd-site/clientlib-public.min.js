...
//# sourceMappingURL=/etc/designs/byd-site/clientlib-public/resources/axios.min.map
...
(function() {
  ...
  document.addEventListener("click", function(e) {
    ...
    e = e || window.event;
    let target = e.target;
    if (target.className.indexOf("js-ga") > -1) {
      let { gaEvent, gaEc, gaEa, gaEl } = target.dataset;
      window.dataLayer.push({
        event: gaEvent || "uaEvent",
        "eventCategory": gaEc,
        "eventAction": gaEa || (((_a = window.siteInfo) == null ? void 0 : _a.pageType) || "other"),
        "eventLabel": gaEl
      });
      window.adobeDataLayer.push({
        event: gaEvent || "uaEvent",
...
document.addEventListener("lazybeforeunveil", function(e) {
  ...
  if (window.innerWidth < 992) {
    ele.setAttribute("poster", ele.getAttribute("data-poster-m"));
    ele.querySelector("source").setAttribute("src", ele.querySelector("source").getAttribute("data-src-m"));
  } else {
    ele.setAttribute("poster", ele.getAttribute("data-poster-p"));
...
Vue.createApp({
  setup() {
    ...
    let recordCookies = localStorage.getItem("recordCookies");
      ...
      customScript: [
        {
          ...
          content: `(function (w, d, s, l, i) {
              ...
              })(window, document, 'script', 'dataLayer', 'GTM-53W95WK');`
        },
        { type: "src", scriptType: "analysis", position: "head", content: "https://www.googletagmanager.com/gtag/js?id=G-8K4383HRLQ" },
        { type: "src", scriptType: "analysis", position: "head", content: "https://www.googletagmanager.com/gtag/js?id=UA-240323972-1" },
        { type: "custom", scriptType: "analysis", position: "head", content: `window.dataLayer = window.dataLayer || []; function gtag() { dataLayer.push(arguments); } gtag('js', new Date()); gtag('config', 'G-8K4383HRLQ'); gtag('config', 'UA-240323972-1');` },
        { type: "src", scriptType: "analysis", position: "head", content: "https://assets.adobedtm.com/2654a96c6503/9603064e3cf3/launch-f4c17bb0d1a9.min.js" }
      ],
      customScriptDom: []
    });
    ...
    const acceptSelect = () => {
      if (cookieSetting.analysis) {
        localStorage.setItem("recordCookies", "1");
        addCustomScript();
      } else {
        localStorage.setItem("recordCookies", "0");
      }
