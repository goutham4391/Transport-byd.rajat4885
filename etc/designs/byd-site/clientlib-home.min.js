...
let h01 = {
  ...
  scrollAnimation: function(target, dir) {
    ...
    let speed = Math.abs(oTop - target) / 17 * dir;
    cancelAnimationFrame(h01.animateTimer);
    if (h01.scrollDir == 1) {
      h01.animateTimer = requestAnimationFrame(function fn() {
        ...
        if (oTop < target) {
          ...
          h01.animateTimer = requestAnimationFrame(fn);
        } else {
          cancelAnimationFrame(h01.animateTimer);
        }
      });
  ...
  getContainerDom: function() {
    document.querySelectorAll(".byd-kvBanner-container").forEach((item) => {
